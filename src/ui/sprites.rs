...
const IDLE_FRAMES: &[[&str; 3]] = &[
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2557}", "\u{255a}\u{2569}\u{255d}"],
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2557}", " \u{2551} "],
];

const TYPING_FRAMES: &[[&str; 3]] = &[
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2557}", "\u{255a}\u{2569}\u{255d}"],
    [" \u{25c9} ", "\u{2554}\u{2551}~", "\u{255a}\u{2569}\u{255d}"],
    [" \u{25c9} ", "~\u{2551}\u{2557}", "\u{255a}\u{2569}\u{255d}"],
];

const READING_FRAMES: &[[&str; 3]] = &[
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2590}", "\u{255a}\u{2569}\u{255d}"],
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2590}", "\u{255a}\u{2569}\u{255d}"],
];

const WALKING_FRAMES: &[[&str; 3]] = &[
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2557}", "\u{255d} \u{255a}"],
    [" \u{25c9} ", "\u{2554}\u{2551}\u{2557}", "\u{255a} \u{255d}"],
];
